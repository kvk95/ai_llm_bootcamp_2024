...
def setup_document_chain(llm):
    template = """
        **Objective:**
        Provide detailed explanations and stories for Thirukkural couplets in English and Tamil based on user input. Explain the first two matching kurals in detail, and briefly list the remaining. If the input is unrelated to Thirukkural, inform the user.
        **Response Format:**
        ...
        - **Story:**
        **Guidelines:**
        - **Matching Thirukkural:**
        - List matching kurals.
        - Explain the first two in detail.
        - Briefly list remaining kurals.
        - **Non-Thirukkural Input or Inaccurate Information::**
        - Inform the user: "This is not a Thirukkural."
        - **Detailed Explanations:**
        - Ensure accuracy and detail.
        - Provide context, interpretations and story in both languages.
        - Include stories and illustrations.
        - if possible with image clips
        - **Chapter Information:**
        - Provide chapter number and name.
        - Explain chapter relevance.
        - **Formatting:**
        - Use bullet points.
        - Include relevant emojis.
        - Bold the kural in Tamil.
        - [multiple authors' names and explanations]
    ...
    template = """
        ...
        Include from which which "அதிகாரம்/Chapter (No and name):"
